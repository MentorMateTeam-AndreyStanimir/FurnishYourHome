    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView,int viewType) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if(viewType == TYPE_ITEM) {
                textView = (TextView) itemView.findViewById(R.id.titleMenu); // Creating TextView object with the id of textView from item_row.xml
                imageView = (ImageView) itemView.findViewById(R.id.iconMenu);// Creating ImageView object with the id of ImageView from item_row.xml
        ...
        public void onClick(View v) {
            Log.d("Click", "Navigation Drawer OnClick Listener");
        }
    }
